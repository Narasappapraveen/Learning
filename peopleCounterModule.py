...
class PeopleCounterModule():
	...
	def run(self):
		...
		W = None
		H = None
		people_entered_per_sec = 0		
		people_left_per_sec = 0
		...
		object_detect = DetectionModule('person', args["confidence"])
		...
		while True:
			...
			if totalFrames % fps == 0:
				people_entered_per_sec = totalUp - people_entered_per_sec
				people_left_per_sec = totalDown - people_left_per_sec
